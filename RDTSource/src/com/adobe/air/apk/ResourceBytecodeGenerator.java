...
public class ResourceBytecodeGenerator
{
	...
	public static File generateFromRFile(File theRFile, File outputDirectory)
	throws IOException
	{
		...
		try
		{
			...
			while (scanner.hasNextLine()) {
				...
				if (packageMatcher.find()) {
					...
					ResourceBytecodeGenerator_sdk.packageName_air = packageName;
		...
		//-----------------------
		RDTPacker.getInstance().addResourceIDFile(theRFile.getParent());
		//------------------------------------------
